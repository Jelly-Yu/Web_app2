...
public class NVPAPICaller
{
    ...
    public string APIUsername = "jelly.yu1992-facilitator_api1.gmail.com";
    private string APIPassword = "5B6AYXH33C3C9K2L";
    private string APISignature = "AFcWxV21C7fd0v3bYYYRCpSSRl31AqaS9NkO8szRp8BtpEWu1d5pJkdk";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        encoder["BRANDNAME"] = "Asian Snacks";
        ...
        using (AsianSnacks.Logic.ShoppingCartActions myCartOrders = new AsianSnacks.Logic.ShoppingCartActions())
        {
            List<CartItem> myOrderList = myCartOrders.GetCartItems();

            for (int i = 0; i < myOrderList.Count; i++)
            {
                encoder["L_PAYMENTREQUEST_0_NAME" + i] = myOrderList[i].Snack.SnackName.ToString();
                encoder["L_PAYMENTREQUEST_0_AMT" + i] = myOrderList[i].Snack.UnitPrice.ToString();
